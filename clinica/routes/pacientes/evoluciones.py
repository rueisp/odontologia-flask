# clinica/routes/pacientes/evoluciones.py

from flask import redirect, url_for, flash, request, render_template, current_app
from flask_login import login_required, current_user
from sqlalchemy.orm import load_only

# 1. CAMBIO DE PUNTOS: Usamos 3 puntos (...) para llegar a la raíz de clinica
...
@pacientes_bp.route('/editar_evolucion/<int:id>', methods=['GET', 'POST'])
@login_required
...
@pacientes_bp.route('/agregar_evolucion/<int:paciente_id>', methods=['POST'])
@login_required
...
@pacientes_bp.route('/eliminar_evolucion/<int:id>', methods=['POST'])
@login_required
