"""Full initial schema including all patient and user fields

Revision ID: 4ff753de7eb4
Revises: 
Create Date: 2025-09-05 13:05:39.983903
...
def upgrade():
    ...
    sa.Column('imagen_1_url', sa.String(length=200), nullable=True),
    sa.Column('imagen_2_url', sa.String(length=200), nullable=True),
    sa.Column('dentigrama_url', sa.String(length=255), nullable=True),
