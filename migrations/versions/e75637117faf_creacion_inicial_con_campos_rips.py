...
def upgrade():
    ...
    sa.Column('paciente.nombres', sa.String(length=100), nullable=False),
    sa.Column('paciente.apellidos', sa.String(length=100), nullable=False),
    sa.Column('paciente.telefono', sa.String(length=50), nullable=True),
