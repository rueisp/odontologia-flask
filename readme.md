...
gcloud builds submit --tag gcr.io/odontologia-app-rps/odontologia-flask:v29
...
gcloud run deploy clinica-test --image gcr.io/odontologia-app-rps/odontologia-flask:v29 --region us-central1 --allow-unauthenticated
